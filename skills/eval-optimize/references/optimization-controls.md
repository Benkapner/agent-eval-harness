...
|-------|-----------|---------|-----------|
| Train | 20% | Generate edit candidates | Steps 2-4 |
| Selection | 10% | Validation gate | Step 5 |
| Test | 70% | Final measurement only | Step 8 |

Splitting is deterministic (seed 42). Use `scripts/split_dataset.py`. Small datasets (< 10 cases): train and selection overlap.
