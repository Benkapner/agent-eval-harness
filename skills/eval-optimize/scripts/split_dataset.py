...
iterations. The split ratio is specified as train:selection:test (e.g., 20:10:70).

Usage:
    python3 split_dataset.py --dataset <path> --ratio 20:10:70 --output tmp/splits.yaml
"""
...
def split_cases(case_ids, ratio_str, seed=42):
    ...
    if n < 10:
        # Small dataset: overlap train and selection
        n_test = max(1, round(n * parts[2] / total_ratio))
        n_train_sel = n - n_test
...
def main():
    ...
    parser.add_argument("--ratio", default="20:10:70", help="train:sel:test ratio")
