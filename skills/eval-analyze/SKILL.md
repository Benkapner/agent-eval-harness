...
1. For each peer skill (excluding the target and eval harness skills), read the first 15 lines of its SKILL.md to get the frontmatter description
...
3. Read CLAUDE.md (if it exists) and scan for rules that overlap with the target skill's content
